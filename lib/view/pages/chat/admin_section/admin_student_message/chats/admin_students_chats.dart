...
class AdminToStudentsChatsScreen extends StatefulWidget {
  final String studentDocID;
  final String studentName;

  const AdminToStudentsChatsScreen(
      {required this.studentDocID, required this.studentName, super.key});

  @override
  State<AdminToStudentsChatsScreen> createState() => _AdminToStudentsChatsScreenState();
}

class _AdminToStudentsChatsScreenState extends State<AdminToStudentsChatsScreen> {
