                    ...
                    if (snapshot.hasData) {
                      return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          final data = AdminDetailsModel.fromMap(snapshot.data!.docs[index].data());
                          return Column(
                            children: [
                              Container(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                            ...
                                            child: GestureDetector(
                                              onTap: () {
                                                if (adminController.secondaryAdmin.value == false) {
                                                  data.active == true
                                                      ? customShowDilogBox2(
                                                          children: [
                                                            const TextFontWidget(
                                                              text:
                                                                  "Do you want to deactivate this admin now?",
                                                              fontsize: 14,
                                                            )
                                                          ],
                                                      ...
                                                      : customShowDilogBox2(
                                                          children: [
                                                            const TextFontWidget(
                                                              text:
                                                                  "Do you want to activate this admin now?",
                                                              fontsize: 14,
                                                            )
                                                          ],
                                                          doyouwantActionButton: true,
