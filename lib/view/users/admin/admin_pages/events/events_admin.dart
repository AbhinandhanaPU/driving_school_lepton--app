...
import 'package:new_project_app/view/users/admin/admin_pages/events/event_display_admin.dart';
...
class EventsListAdmin extends StatelessWidget {
  EventsListAdmin({super.key});
                            ...
                            child: ListTileCardWidget(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EventDisplayAdmin(
                                      data: data,
                                    ),
                                  ),
                                );
