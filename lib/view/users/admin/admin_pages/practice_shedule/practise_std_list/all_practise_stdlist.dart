...
import 'package:new_project_app/view/users/admin/admin_pages/practice_shedule/practise_std_list/practise_std_profile.dart';
import 'package:new_project_app/view/widgets/loading_widget/loading_widget.dart';
import 'package:new_project_app/view/widgets/text_font_widget/text_font_widget.dart';

class AllPractiseScheduleStudentList extends StatelessWidget {
  final PracticeSheduleModel id;
  AllPractiseScheduleStudentList({super.key, required this.id});
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(
                                  builder: (context) {
                                    return PractiseScheduleStudentProfile(
                                      stdata: data,
                                    );
                                  },
                                ));
