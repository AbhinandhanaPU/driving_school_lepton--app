                          ...
                          child: const Row(
                            children: [
                              ...
                              Expanded(
                                  flex: 6,
                                  child:
                                      CatrgoryTableHeaderWidget(headerTitle: 'Shedule Practice')),
                              SizedBox(
                                width: 2,
                              ),
                              Expanded(
                                  flex: 6,
                                  child:
                                      CatrgoryTableHeaderWidget(headerTitle: 'Practice Completed')),
                              SizedBox(
                                width: 2,
                              ),
                              Expanded(
                                  flex: 6,
                                  child:
                                      CatrgoryTableHeaderWidget(headerTitle: 'Practice pending')),
                              SizedBox(
                                width: 2,
                              ),
                              Expanded(
