...
import 'package:new_project_app/view/users/admin/admin_pages/notices/notice_create.dart';
import 'package:new_project_app/view/users/admin/admin_pages/notices/notice_display_admin.dart';
import 'package:new_project_app/view/users/admin/admin_pages/notices/notice_edit.dart';
...
class NoticePageAdmin extends StatelessWidget {
  NoticePageAdmin({super.key});
                      ...
                      child: ListTileCardWidget(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  NoticeDisplayAdmin(noticeModel: data),
                            ),
                          );
                        },
                        leading: const Image(
