          ...
          child: StreamBuilder<List<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  if (adminController.openedNotifications.length !=
                      ...
                      return Obx(
                        () => InkWell(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          padding: EdgeInsets.symmetric(
                                              horizontal: 20, vertical: 20),
                                          child: Text(
                                            "${student.studentName} Requested to Join ${course.courseName} Course through ofline payment ",
                          ...
                          child: ListTile(
                            ...
                            title: adminController.openedNotifications[index]
                                ? const Text(
                                    "New Student Request",
                                    style: TextStyle(
