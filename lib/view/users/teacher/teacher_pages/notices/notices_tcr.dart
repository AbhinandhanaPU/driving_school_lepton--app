...
import 'package:new_project_app/view/users/teacher/teacher_pages/notices/notice_display_tcr.dart';
import 'package:new_project_app/view/users/widgets/listcard_widget/listcard_widget.dart';
import 'package:new_project_app/view/widgets/appbar_color_widget/appbar_color_widget.dart';
import 'package:new_project_app/view/widgets/text_font_widgets/google_poppins.dart';

class NoticePageTeacher extends StatelessWidget {
  const NoticePageTeacher({super.key});
                      ...
                      trailing: InkWell(
                        ...
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  NoticeDisplayPageTeacher(noticeModel: data),
                            ),
                          );
                        },
                      ),
