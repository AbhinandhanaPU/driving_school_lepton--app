...
import 'package:new_project_app/view/users/teacher/teacher_pages/practice_shedule_tutor/students_list_tutor/practise_std_datalist_tr.dart';
import 'package:new_project_app/view/widgets/appbar_color_widget/appbar_color_widget.dart';
import 'package:new_project_app/view/widgets/loading_widget/loading_widget.dart';
import 'package:new_project_app/view/widgets/text_font_widget/text_font_widget.dart';

class TutorPracticalStudentsList extends StatelessWidget {
  final PracticeSheduleModel data;

  TutorPracticalStudentsList({
    super.key,
    required this.data,
  });
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          ...
                          return GestureDetector(
                            ...
                            child: TutorPracticeStudentDataList(
                              data: data,
                            ),
                          );
                        },
