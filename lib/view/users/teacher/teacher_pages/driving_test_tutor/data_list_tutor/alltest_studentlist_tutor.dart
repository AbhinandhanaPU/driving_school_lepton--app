...
import 'package:new_project_app/view/users/teacher/teacher_pages/driving_test_tutor/data_list_tutor/student_profile_test_tutor.dart';
import 'package:new_project_app/view/widgets/loading_widget/loading_widget.dart';
import 'package:new_project_app/view/widgets/text_font_widget/text_font_widget.dart';

class AllTestStudentListOfTutor extends StatelessWidget {
  final TestModel id;
  AllTestStudentListOfTutor({super.key, required this.id});
                            ...
                            return GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(
                                  builder: (context) {
                                    return TutorTestStudentProfile(
                                      stdata: data,
                                    );
                                  },
                                ));
