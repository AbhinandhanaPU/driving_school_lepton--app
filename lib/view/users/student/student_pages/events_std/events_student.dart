...
import 'package:new_project_app/view/users/student/student_pages/events_std/event_display_std.dart';
...
class EventsListOfStudent extends StatelessWidget {
  EventsListOfStudent({super.key});
                            ...
                            child: ListTileCardWidget(
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => EventDisplayStudent(
                                      data: data,
                                    ),
                                  ),
                                );
