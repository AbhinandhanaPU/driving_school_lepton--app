...
import 'package:new_project_app/model/tarif_purchase_model/tarif_purchase_model.dart';
...
class AddRequestedSchoolsToFirebase {
  ...
  Future<void> addRequestedSchools(SchoolsToBeVerified schoolModel, context, String imgUrl) async {
    try {
      _firestore
  ...
  Future<bool> checkSchoolIsCreated(String schoolName, String place) async {
    final schoolListCollection = await _firestore.collection('SchoolListCollection').get();
