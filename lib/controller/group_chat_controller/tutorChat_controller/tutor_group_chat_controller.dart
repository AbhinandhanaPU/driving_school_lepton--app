...
import 'package:new_project_app/model/chat_model/chat_model.dart';
import 'package:new_project_app/view/widgets/text_font_widget/text_font_widget.dart';

class TutorGroupChatMessageController extends GetxController {
          ...
          child: Column(
            ...
            children: [
              Padding(
                  ...
                  child:
                      TextFontWidget(text: username, fontsize: 10)),
              Container(
                padding:
                    const EdgeInsets.symmetric(vertical: 8, horizontal: 14),
